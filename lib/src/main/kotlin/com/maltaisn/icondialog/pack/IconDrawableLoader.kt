 ...
 */
open class IconDrawableLoader(context: Context, private val sizeAdjustDp: Int = 0) {
    ...
    fun loadDrawable(icon: Icon) {
        ...
        if (icon.srcId != null) {
            ...
            val binXml = createDrawableBinaryXml(icon.pathData, icon.width, icon.height, sizeAdjustDp)
            try {
    ...
    companion object {
        ...
        private val BIN_XML_END = shortArrayOf(
                ...
                0x01 /* <- dp?*/, 0x18 /* <- icon width[int] = 24 */, 0x00, 0x00, 0x06,
                0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0x08,
                0x00, 0x00, 0x05, 0x01, 0x18 /* <- icon height[int] = 24 */, 0x00, 0x00,
                0x06, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF,
                0x08, 0x00, 0x00, 0x04,
                0x00, 0x00, 0x00, 0x00, // <--icon viewport width [float] = 0
                0x06, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF,
                0x08, 0x00, 0x00, 0x04,
                0x00, 0x00, 0x00, 0x00, // <-- icon viewport height [float] = 0
                0x02, 0x01, 0x10, 0x00, 0x4C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x07, 0x00, 0x00, 0x00,
                0x14, 0x00, 0x14, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x06, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF,
                0x08, 0x00, 0x00, 0x1D, 0x00, 0x00, 0x00, 0xFF, 0x06, 0x00, 0x00, 0x00,
                0x05, 0x00, 0x00, 0x00, 0x09, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x03,
                0x09, 0x00, 0x00, 0x00, 0x03, 0x01, 0x10, 0x00, 0x18, 0x00, 0x00, 0x00,
         ...
         */
        private fun createDrawableBinaryXml(pathData: String, width: Int, height: Int, sizeAdjustDp: Int): ByteArray {
            ...
            // Write drawable size attributes
            if (sizeAdjustDp!=0) {
                bb.putInt(index + 84, ((24 + sizeAdjustDp) shl 8) + 1)  // android:width="..."
                bb.putInt(index + 104, ((24 + sizeAdjustDp) shl 8) + 1)  // android:height="..."
            }
